...
downloadCv.addEventListener("click", (e) => {
  ...
  aElement.setAttribute("download", "kanthakamadumalkaFinalCV.pdf");
  aElement.setAttribute("href", "kanthakamadumalkaFinalCV.pdf"); // If the file is in the 'assets' folder
